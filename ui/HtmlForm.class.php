...
class HtmlForm
{
	...
	/**
	 * @param array $params		{PARAM_HIDDEN:{hidden inputs}
	 * 	, PARAM_VALUES:{field_name1:'value',...}
	 *	, PARAM_SETS:[{SET_LEGEND:'legend'|{SET_LEGEND_CONTENT:'legend', legend tag attributes}
	 *		, 0:{field_name1:{FIELD_MODE:..., FIELD_REQUIRED:..., FIELD_LABEL:...
	 *				, FIELD_COMMENT:'comment', FIELD_INPUT:{input tag attributes}
	 *				, FIELD_REPOSITORY:{repository params for unregistered field}
	 *				, FIELD_MARGIN:true, FIELD_WIDTH:WIDTH_1_2
	 *
	 *				, d.t.a. (field)
	 *				}
	 *			, 0:'field content string', ...
	 *			, div tag attributes(row)
	 *			}
	 *		, 1:{0:{FIELD_REQUIRED:..., FIELD_LABEL:..., FIELD_CONTENT:..., d.t.a. (field)}, ..., d.t.a. (row)}
	 *		, 2:'just a string'
	 *		, ...
	 ...
	 * @param array $params		{FIELD_NAME:'birthday', FIELD_LABEL:'Contact birthday', FIELD_COMMENT:...
	 ...
	 * @param array $params		{FIELD_NAME:'birthday', FIELD_LABEL:'Contact birthday', FIELD_COMMENT:...
	 *							, FIELD_VALUE:'1972-09-22', FIELD_REQUIRED:bool
	 *							, FIELD_REPOSITORY:repository field attributes
