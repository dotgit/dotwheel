...
EOco
	 ...
	 * @staticvar int $cnt
	 * @param array $params	{P_LABEL:'', {P_LABEL:..., P_LABEL_ATTR:..., P_ACTIVE:..., 1st a tag attributes}, {2nd...}, container div attributes}
	 * @return string
	 */
	 ...
	 * @staticvar int $cnt
	 * @param array $params	{{P_LABEL:..., P_CONTENT:..., 1st button tag attributes}, {2nd...}, container div attributes}
	 * @return string
	 */
...
EOct
	 ...
	 * @param array $rows	{{{P_WIDTH:..., P_CONTENT:'cell_content'}, 'cell_content', 'row_attr':'value'}
	 *						, 'row_content'
	 *						, container div tag attributes
	 *						}
	 * @return string
