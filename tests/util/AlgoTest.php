...
class AlgoTest extends PHPUnit_Framework_TestCase
{
    ...
    public function luhnProvider()
    {
        return [
            'wiki'=>[true, '972487086'],
            'wiki2'=>[true, '732829320'],
            'wiki3'=>[true, '73282932000074'],
            'wiki3 modified'=>[false, '73282932000075'],
            'wiki4'=>[true, '49927398716'],
            'wiki5'=>[false, '49927398717'],
            'wiki6'=>[false, '1234567812345678'],
            'wiki7'=>[true, '1234567812345670'],
        ];
    }
