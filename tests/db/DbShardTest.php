...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2016-04-07 at 23:21:15.
 * @coversDefaultClass Dotwheel\Db\DbShard
 * @requires PHP 5.4
 * @requires extension mysqli
 */
class DbShardTest extends DbBeforeClass
{
    public static $shard_users = 'shard_users_';
    public static $shard_contracts = 'shard_contracts_';
    public static $shard_storage = 'shard_storage_';
    ...
    public function testOpen()
    {
        ...
        $this->assertCount(3, Db::fetchList(sprintf(
