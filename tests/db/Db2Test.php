...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2016-04-07 at 16:41:11.
 * @coversDefaultClass Dotwheel\Db\Db2
 * @requires PHP 5.4
...
class Db2Test extends DbBeforeClass
{
    ...
    {
        $this->assertEquals(1, Db2::insert([
        ...
        $this->assertEquals(0, Db2::insert([
            Db2::P_IGNORE=>true,
            Db2::P_TABLE=>self::TABLE,
            Db2::P_FIELDS=>[
                self::C_SECTION=>Db2::FMT_NUM,
        ...
        $this->assertEquals(2, Db2::insert([
            Db2::P_TABLE=>self::TABLE,
            Db2::P_FIELDS=>[
                self::C_SECTION=>Db2::FMT_NUM,
                self::C_ID=>Db2::FMT_NUM,
    ...
    {
        $this->assertEquals(1, Db2::update([
            Db2::P_TABLE=>self::TABLE,
            Db2::P_FIELDS=>[
                self::C_NAME=>Db2::FMT_ALPHA,
            ],
