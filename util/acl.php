...
class Acl
{
     ...
     * @return bool  returns true if at least one present acl is a subset of
     ...
     */
    public static function containsRequired(array $present, $required): bool
    {
        foreach ((array)$required as $r) {
            if ($r & 0x0000ff) {
                if (in_array($r, $present)) {
                    return true;
                }
            } elseif ($r & 0x00ffff) {
